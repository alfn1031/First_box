...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 모델에서 View에서 일어난 처리작업 결과를 View로 반환
		...
		// Delete(삭제) : 저장되어있는 축구선수들의 데이터를 삭제
		
		// 공지사항 (C : 게시글 작성, R : 게시판, U : 게시글 수정, D : 게시글삭제)
		// 회원 	 (C : 회원가입, R : 마이페이지(내 정보조회), U : 내정보수정, D : 회원 탈퇴)
		/*
		 * 회원의 C를 구현해야겠다
		 * 
		 * 아이디, 비밀번호, 전화번호, 이메일
		 ...
		 * 공지사항의 C를 구현해야겠다
		 * 
		 * 게시글, 게시글 내용, 게시글 작성자, 카테고리
		 * public void NoticeVO {
