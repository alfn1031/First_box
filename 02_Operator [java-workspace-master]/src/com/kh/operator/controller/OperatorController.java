...
public class OperatorController {
	...
	public void test() {
		System.out.println("메소드 호출 할 때 꼭 메인에서만 불러야하는 것 은 아닙니다.");
	...
	public void logicalnagation() {
		/*
		 * 논리 부정 연산자 : 논리값(true / false)을 반대로 바꿔주는
		 * 
		 */
	...
	public void comparison() {
		 ...
		 * 특정 조건을 제시 할 수 있는 조건문에서 조건식으로 사용할 것 
		 */
...
//		 * 1. AND 연산 : 논리값 && 논리값
	...
	public void andOper() {
		...
		// 1. 사용자가 입력한 정수가 1~10사이의 값인지 출력하기
		// 1_1. 사용자가 입력한 값 => num
		// 1_2. 1
		// 1_3. 10
		...
		System.out.println("입력값이 1부터10사이의 값인가요?" + result);
		
	}
	
	public void orOper() {
		// 사용자에게 한 글자를 입력 받아서 
		// 입력받은 글자가 'A' 또는 'a'인지 확인하고 출력하기
		Scanner sc = new Scanner(System.in);
		System.out.print("반드시 한 글자만 입력해주세요");
	...
	public void triple() {
		...
		// 메뉴번호가 1번일시 AI치킨 나오게하고 1번이 아닐시 없는메뉴입니다 라고 출력
