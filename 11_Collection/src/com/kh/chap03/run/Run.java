...
public class Run {
	...
	public static void main(String[] args) {
		...
		System.out.println(set); // 저장순서 보장X, 중복허용X
		
		// 요소 개수 구하기 size()
		System.out.println(set.size());
		// 주병 식당들 정보를 set에 담아야겠다
		Set<Shop> shops = new HashSet();
		
		Shop gongShop = new Shop("공평동 꼼장어", "꼼장어", 15000);
		...
		/*
		 * equals()의 호출 결과가 true이고 hashCode()의 반환값을 동등비교 연산자를 ㅌㅇ해
		 * 비교했을 떄 값이 일치한다면 -> 동일객체로 판단(중복저장을 하지 않음)
		 * 
		...
		*/
		...
		// HashSet -> 해시테이블
		// TreeSet -> 트리
		// 개발자가 구체적인 자료구조를 고르더라도 반복을 시킬 수 있는 방법
